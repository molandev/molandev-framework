...
@DisplayName("RedisLockFactory测试")
class RedisLockFactoryTest {

    private static RedisServer redisServer;
    private RedisTemplateLockFactory redissonLockFactory;
    ...
    void setUp() {
        ...
        org.springframework.data.redis.connection.lettuce.LettuceConnectionFactory connectionFactory = 
            new org.springframework.data.redis.connection.lettuce.LettuceConnectionFactory(redisConfig);
        ...
        // 创建 RedisTemplateLockFactory 实例
        redissonLockFactory = new RedisTemplateLockFactory(redisTemplate);
    }
